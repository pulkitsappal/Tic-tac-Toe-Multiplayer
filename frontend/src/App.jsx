...
const App = () => {
  ...
  return (
    <div className='main-div'>
      ...
      <div>
        {finishedState && finishedState !== 'draw' && finishedState !== playingAs && (
          <h3 className='finished-state'>{opponentName} won the game.</h3>
        )}
        {finishedState && finishedState !== 'draw' && finishedState === playingAs && (
          <h3 className='finished-state'>You won the game.</h3>
        )}
      ...
      <div className='credentials'>Developer: <a href='https://github.com/pulkitsappal' target='_blank'>Pulkit</a></div>
